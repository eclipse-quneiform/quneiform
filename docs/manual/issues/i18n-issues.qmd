...
This can even be an issue for English.
...
Here a number is being formatted into this message at runtime.
It is better to pass singular and plural variations to a pluralizing function instead.
For example:
...
render_grviz(render_graph(words_graph))
```
