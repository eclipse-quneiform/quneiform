...
Another option is to use gender-neautral language instead of relying on a list of dynamic pronouns.
...
And we have another message which dynamically replaces "%s" with one of the above values:
...
Another option is to replace the message with gender-neautral language:
