...
**Check for inconsistent casing, separators, or trailing punctuation, spaces, or newlines**: select this to check for the following between source and translation strings:
...
Like **European**, the translation will be clearly different, but somewhat readable.
::::
